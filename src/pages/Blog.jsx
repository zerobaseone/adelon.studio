      ...
      <main className="page-shell">
        <section className="stack">
          <TerminalWindow title="⚠️ cognitohazard - blog ai policy">
            If you're here, i'm assuming you want to hear from me and not{' '}
            <a href="https://youtu.be/LPZh9BOjkQs?si=b2c4NSz-tDHZ-SEo">several matrices</a>, so all posts are written by me with no LLM assistance.
          </TerminalWindow>
